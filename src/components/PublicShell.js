    ...
    <div style={{
      ...
      <nav style={{
        ...
        <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 12, textDecoration: 'none' }}>
          ...
          />
          {/* Fallback emblem if logo missing */}
          <div style={{
            display: 'none', width: 42, height: 42, borderRadius: '50%',
            background: '#f59e0b', alignItems: 'center', justifyContent: 'center',
            fontSize: 20, color: '#0f172a', fontWeight: 800, border: '2px solid #f59e0b',
          }}>
            ⚜
          </div>
          <div>
            ...
            <div style={{ color: '#f59e0b', fontWeight: 700, fontSize: 10, letterSpacing: '0.12em' }}>
              BOYS CAMPUS — PORTAL
            </div>
          </div>
        </Link>

        {/* Nav links — always show text */}
      ...
      <div style={{
        ...
        <div style={{ marginBottom: 20 }}>
          <img
            src="/logo.png"
            alt="COE Logo"
            style={{ width: 72, height: 72, borderRadius: '50%', objectFit: 'cover', border: '3px solid #f59e0b' }}
        ...
        {subtitle && (
          <p style={{
            margin: 0, fontSize: 15, color: '#94a3b8',
      ...
      <footer style={{
        ...
        <div style={{ marginBottom: 12 }}>
          <img
            src="/logo.png"
            alt="COE Logo"
            style={{ width: 44, height: 44, borderRadius: '50%', objectFit: 'cover', border: '2px solid #334155' }}
            onError={e => { e.target.style.display = 'none'; }}
          />
        </div>
